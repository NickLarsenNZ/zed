use gpui::{
    div, hsla, point, px, size, App, AppContext, Bounds, BoxShadow, Div, IntoElement,
        ...
        div()
            ...
            .child(
                div()
                    ...
                    .child(card("inset md").shadow(smallvec![BoxShadow {
                    ...
                    .child(card("inset lg").shadow(smallvec![BoxShadow {
                        color: hsla(0., 0., 0., 0.15),
                    ...
                    .child(card("inset xl").shadow(smallvec![BoxShadow {
                        color: hsla(0., 0., 0., 0.15),
...
fn main() {
    App::new().run(|cx: &mut AppContext| {
        ...
        cx.open_window(
            ...
            |cx| cx.new_view(|_cx| InsetShadowExample),
        );
    });
}
